...
type MapKey interface {
	fmt.Stringer
	Unmarshal(b []byte, keySize int64) (int, error)
}

type SignedIntegerKey int32

func (v *SignedIntegerKey) Unmarshal(b []byte, keySize int64) (int, error) {
...
func (v *IPv4AddressKey) Unmarshal(b []byte, keySize int64) (int, error) {
	if keySize != 4 {
...
func (v *IPv6AddressKey) Unmarshal(b []byte, keySize int64) (int, error) {
	if keySize != 16 {
...
func (v *StringKey) Unmarshal(b []byte, keySize int64) (int, error) {
...
func (v *BinaryKey) Unmarshal(b []byte, keySize int64) (int, error) {
	*v = b[:keySize]
